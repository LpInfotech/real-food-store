...
const Home = (data) => {
    ...
    return (
        <div className='bg-white dark:bg-slate-800 dark:text-white text-black'>
            ...
            {/* why choose section */}
            <div className="text-center py-8 gap-x-20 px-10">
                <h2 className="text-5xl mt-5 mb-16">Why Choose Us?</h2>
            ...
            <div className="my-20">
                <h2 className="text-5xl my-5 text-center">Our Best Sellers</h2>
                <h4 className="font-medium text-gray-500 text-lg text-center">Best Seller Product This week</h4>
            ...
            <div className="bg-gray-100 grid grid-cols-2">
                <div className="col-span-1 h-full flex flex-col items-center justify-center">
                    ...
                    <a href="/" target="_blank"><button type="button" className="bg-transparent border border-black py-4 px-10 font-medium hover:text-white hover:bg-black">Shop Now</button>
                    </a>
                </div>
